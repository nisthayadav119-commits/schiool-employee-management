...
<div class="leftside-menu">
  ...
  <div class="h-100" id="leftside-menu-container" data-simplebar>
    ...
    <ul class="side-nav">
      ...
      <li class="side-nav-title">Class</li>

      <li class="side-nav-item">
        <a href="time-table.php" class="side-nav-link">
      ...
      <li class="side-nav-item">
        <a href="period-list.php" class="side-nav-link">
          <i class="ri-calendar-event-line"></i>
          <span> Period List </span>
        </a>
      </li>
      
      <li class="side-nav-item">
        <a href="class-list.php" class="side-nav-link">
          <i class="ri-calendar-event-line"></i>
      ...
      <li class="side-nav-item">
        <a href="teachers.php" class="side-nav-link">
          <i class="ri-calendar-event-line"></i>
          <span> Teachers </span>
        </a>
      </li>
      ...
      <li class="side-nav-item">
        ...
        <div class="collapse" id="sidebarEmail">
          <ul class="side-nav-second-level">
            ...
            <li>
              <a href="terminate-employee.php">Terminate List</a>
            </li>
          </ul>
        </div>
      </li>
